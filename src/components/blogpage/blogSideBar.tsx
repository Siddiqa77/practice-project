...
export function BlogSidebar() {
  return (
    <div className="space-y-8 md:w-[250px]">
      ...
      <div>
        ...
        <div className="space-y-2 grid grid-cols-2 justify-between">
          {[
            ...
            { name: "Bags", count: 17 },
            { name: "Accessories", count: 15 },
            { name: "Jwellery", count: 13 },
          ].map((category) => (
            <div
              key={category.name}
              className="flex items-center gap-2 text-[#151875] text-sm"
            >
      ...
      {/* Recent Posts */}
      <div>
        <h3 className="text-lg text-[#151875] font-semibold mb-4">
          Recent Post
        </h3>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <a
            href="#"
            className="w-8 h-8 rounded-full bg-purple-700 font-semibold text-white flex items-center justify-center"
          >
            f
          </a>
          <a
            href="#"
            className="w-8 h-8 rounded-full bg-[#FB2E86] text-white flex items-center justify-center"
          >
            in
          </a>
          <a
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 ">
          {["General", "Atsanil", "Insas", "Bibsaas", "Nulla"].map((tag) => (
            <span
              key={tag}
              className="px-3 py-1 text-[#151875] hover:text-pink-500 underline cursor-pointer bg-gray-100 rounded-full text-sm"
            >
              {tag}
            </span>
          ))}
